...
import math
from models.longformer.utils.sliding_chunk import sliding_chunks_matmul_qk, sliding_chunks_matmul_pv
from models.longformer.utils.diagonaled_mm_tvm import diagonaled_mm as diagonaled_mm_tvm, mask_invalid_locations
from models.longformer.utils.sliding_chunk import sliding_chunks_no_overlap_matmul_qk, sliding_chunks_no_overlap_matmul_pv
...
class LongformerSelfAttention(nn.Module):
    ...
    def forward(
        ...
        if remove_from_windowed_attention_mask is not None:
            # This implementation is fast and takes very little memory because num_heads x d_model = 1
            # from (bsz x seq_len) to (bsz x seq_len x num_heads x d_model)
        ...
        outputs = (context_layer, attn_weights) if output_attentions else (context_layer, None)
        return outputs