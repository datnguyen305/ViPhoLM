...
from .module import Encoder, Decoder, ClosedbookDecoder
...
class ClosedbookSummarization(PointerGenerator):
    def __init__(self, config, vocab: Vocab):
        ...
        self.is_attention_closedbook = config.is_attention_closedbook
        ...
        self.closedbook_decoder = ClosedbookDecoder(self.config, self.vocab)
