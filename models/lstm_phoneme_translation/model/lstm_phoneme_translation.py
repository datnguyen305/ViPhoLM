...
from models.lstm_phoneme_translation.layers.encoder import Encoder
from models.lstm_phoneme_translation.layers.decoder import Decoder
from builders.model_builder import META_ARCHITECTURE


@META_ARCHITECTURE.register()
class LSTM_Model3layer_MT(nn.Module):
    def __init__(self, config, vocab: MTVocab):
        super().__init__()

        self.vocab = vocab
        self.MAX_LENGTH = vocab.vietnamese_max_sentence_length + 2 # + 2 for bos and eos tokens
    ...
    def forward(self, x: torch.Tensor, labels: torch.Tensor):
        ...
        # encoder_outs : (batch_size, seq_len, hidden_size)
