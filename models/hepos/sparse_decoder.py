...
from models.hepos.decoder.AdaptCrossAttn import DivideMultiheadAttention
...
class SparseTransformerDecoderLayer(TransformerDecoderLayer):
    ...
    def build_encoder_attention(self, embed_dim, args):
        # Luôn trả về DivideMultiheadAttention với cấu hình của HEPOS
        return DivideMultiheadAttention(
            embed_dim,
            ...
            divide_type='stride',  # Cố định logic là 'stride' - chính là HEPOS
            encoder_max_positions=args.max_source_positions,
            divide_ratio=args.divide_ratio  # Đây sẽ là stride size
        )
