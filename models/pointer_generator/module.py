...
class Encoder(nn.Module):
    ...
    def forward(self, encoder_input, source_length):
        packed_source_embeddings = pack_padded_sequence(encoder_input, source_length.cpu(),
        ...
        # encoder_outputs: B x S x (2*H) 
        # encoder_hidden_states: (num_layers * num_directions) x B x H
...
class Decoder(nn.Module):
    def __init__(self, config, vocab: Vocab):
        ...
        self.is_coverage = config.is_coverage and config.is_attention
