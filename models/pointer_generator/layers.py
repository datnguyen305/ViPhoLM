...
from models.pointer_generator.basic import BasicModule
from models.pointer_generator.attention import Attention
...
class Encoder(BasicModule):
    def __init__(self, config, vocab):
        ...
        self.src_word_emb = nn.Embedding(vocab.vocab_size, config.emb_dim)
...
class Decoder(BasicModule):
    def __init__(self, config, vocab: Vocab):
        ...
        # decoder
        self.tgt_word_emb = nn.Embedding(vocab.vocab_size, config.emb_dim)
        ...
        self.fc2 = nn.Linear(config.hidden_dim, vocab.vocab_size)
